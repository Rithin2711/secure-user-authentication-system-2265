...
/**
 * Required field paths (UI-only).
 * These are used by InputValidationPage to locate missing or empty fields and
 * drive a Human-in-the-Loop (HITL) re-upload prompt.
 */
